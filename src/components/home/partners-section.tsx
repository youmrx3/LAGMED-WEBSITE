...
const partners = [
  {
    name: "GL MEDICAL BBA - HQ",
    name_fr: "GL MEDICAL BBA - Siège",
    name_ar: "GL MEDICAL برج بوعريريج - المقر الرئيسي",
    city: "Bordj Bou Arreridj",
    city_ar: "برج بوعريريج",
    image: "https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?w=400&q=80",
  },
  {
    name: "GL MEDICAL Algiers",
    name_fr: "GL MEDICAL Alger",
    name_ar: "GL MEDICAL الجزائر العاصمة",
    city: "Algiers",
    city_ar: "الجزائر",
    image: "https://images.unsplash.com/photo-1586773860418-d37222d8fce3?w=400&q=80",
  },
  {
    name: "GL MEDICAL Constantine",
    name_fr: "GL MEDICAL Constantine",
    name_ar: "GL MEDICAL قسنطينة",
    city: "Constantine",
    city_ar: "قسنطينة",
    image: "https://images.unsplash.com/photo-1559757175-5700dde675bc?w=400&q=80",
  },
  {
    name: "GL MEDICAL Oran",
    name_fr: "GL MEDICAL Oran",
    name_ar: "GL MEDICAL وهران",
    city: "Oran",
    city_ar: "وهران",
    image: "https://images.unsplash.com/photo-1629909613654-28e377c37b09?w=400&q=80",
  },
  {
    name: "GL MEDICAL Sétif",
    name_fr: "GL MEDICAL Sétif",
    name_ar: "GL MEDICAL سطيف",
    city: "Sétif",
    city_ar: "سطيف",
    image: "https://images.unsplash.com/photo-1504439468489-c8920d796a29?w=400&q=80",
  },
  {
    name: "GL MEDICAL Batna",
    name_fr: "GL MEDICAL Batna",
    name_ar: "GL MEDICAL باتنة",
    city: "Batna",
    city_ar: "باتنة",
